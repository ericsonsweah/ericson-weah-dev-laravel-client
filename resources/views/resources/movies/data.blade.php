...
// $(() => {
//    const datum = JSON.parse(moviesData)
//    const genres = datum.genres
//    const movies = datum.movies
//   //  const allMovies = []
//    console.log('Hello World from movies')
//    $('#add-movies-data').on('click', event => {
//      event.preventDefault()
//      for(let movie of movies){
//        delete movie.id
//      }
//       Livewire.emit('addMoviesData', movies)
//    })
